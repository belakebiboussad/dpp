...
class paramController extends Controller
{
    ...
    $conscConsts = json_decode((specialite::FindOrFail(Auth::user()->employ->specialite))->consConst, true);
    ...
    return view('parametres.index',compact('consts','conscConsts','hospConsts','specialites','specExamsBio','specExamsImg','examensImg','antecTypes','specAntecTypes','vaccins','specvaccins','appareils','specappreils'));
  }
