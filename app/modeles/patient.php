...
class patient extends Model
{
  	...
  	protected $fillable = ['code_barre','Nom','Prenom','nom_jeune_fille','Dat_Naissance','Lieu_Naissance','Sexe','situation_familiale' ,
  												 'Adresse','commune_res','wilaya_res','tele_mobile1','tele_mobile2','NSS','group_sang','rhesus','Assurs_ID_Assure','Type',
  													'Type_p','description','active','Date_creation'];
