<div class="row">
	<div class="col-xs-12 widget-container-col" id="consultation">
		<div class="widget-box">
			<div class="widget-header"><h5 class="widget-title">Demande d'examen radiologique :</h5> </div>
	  </div>
		<div class="widget-body">
      <div class="widget-main"><div class="space-12 hidden-xs"></div>
	      <div class="row">
	       	<div class="col-xs-12">
	       		<label for="control-label infosc">Informations cliniques pertinentes :</label>
	        ...
	        <div class="row">
	     		 <div class="col-xs-12">
	      			<label for=" control-label explication">Explication de la demande de diagnostic :</label>
	        ...
	        <div class="row">
	        	<div class="col-xs-12 infosup">
	      	 	<label for=" control-label infos">Informations supplémentaires pertinentes :</label><br>
