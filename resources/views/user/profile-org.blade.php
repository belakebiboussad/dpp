...
@section('main-content')
    ...
    <h3><i class="fa fa-user"></i> Mon Profil</h3>
	</div>
<div class="row">
  ...
  <div class="tab tab-content no-border">
      ...
      <div class="row">
      		<div class="col-md-6 col-sm-6">
      			<ul class="list-unstyled spaced">
      				<li>
			    			<i class="ace-icon fa fa-caret-right blue"></i><i class="ace-icon fa fa-mobile bigger-110"></i> Tél mobile :
    ...
    <form id="form-change-password" role="form" method="POST" action="{{ url('/users/changePassword') }}"onsubmit = "return checkForm(this);">
      ...
      <div class="form-group">
        <label class="col-md-4 control-label" align="right">Mot de passe actuel <span class="red">*</span></label>
        <div class="col-md-6">
          <input type="password" class="form-control" id="curPassword" name="curPassword" placeholder="taper le mot de passe actuel" required/> <small class="help-block"></small>
        </div>
      </div>
      <div class="form-group">
        <label class="col-md-4 control-label" align="right">Nouveau mot de passe :<span class="red">*</span></label>
        <div class="col-md-6">
        ...
        <div class="form-group">
          <label class="col-md-4 control-label" align="right">Confirmer nouveau mot de passe :<span class="red">*</span></label>
          <div class="col-md-6">
