...
<div class="container-fluid">
  ...
  <div class="row">
	   ...
	   <div class="widget-box">
		<div class="widget-body">
			<div class="widget-main">
				...
				<div class="row">
					<div class="form-group col-sm-4 {{ $errors->has('nom') ? 'has-error' : '' }}">
				  ...
				  <div class="form-group col-sm-4 {{ $errors->has('prenom') ? 'has-error' : '' }}">
					 ...
					 <div class="form-group col-sm-4 {{ $errors->has('datenaissance') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-9">
              <input class="form-control date-picker ltnow" type="text" name="datenaissance" placeholder="Date Naissance..." data-date-format="yyyy-mm-dd" autocomplete ="off" required/>
				...
				<div class="row">
					<div class="form-group col-sm-4 {{ $errors->has('lieunaissance') ? 'has-error' : '' }}">
          ...
          <div class="form-group col-sm-4 {{ $errors->has('sexe') ? 'has-error' : '' }}">
          ...
          <div class="form-group col-sm-4 {{ $errors->has('nss') ? 'has-error' : '' }}">
          ...
          <div class="col-sm-3">
            <div class="{{ $errors->has('mail') ? 'has-error' : '' }}">
              ...
              <input type="email" class="col-sm-9 col-xs-9" name="mail" placeholder="E-Mail..." autocomplete="off">
				...
				<h4 class="header block blue">Fonction</h4>
				<div class="row">
	...
	<div class="row">
		<div class="col-sm12 center">
			<button type="submit" class="btn btn-sm btn-primary"><i class="ace-icon fa fa-save icon-on-left bigger-110"></i> Enregistrer	</button>
			<button type="reset" class="btn btn-sm btn-warning"><i class="ace-icon fa fa-undo icon-on-left bigger-110"></i> Annuler</button>
		</div>
	</div>
	</form>
</div>
