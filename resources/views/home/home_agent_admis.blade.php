             ...
             success: function(result) {
                    ...
                    if(result.length != 0){
                          for(var i=0; i<result.length; i++) {  
                                  ...
                                  form +='<a data-toggle="modal" class ="btn btn-info btn-sm" onclick ="ImprimerEtat(\'rdv_hospitalisation\','+result[i].id+')" data-toggle="tooltip" title="Imprimer un Etat de Sortie" data-placement="bottom"'+disabled+'><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>';
                            ...
                            success:function(result,status, xhr)
                            {
                                   if(result.length > 0){
                                          for(var i=0; i<result.length; i++){
                                                  ...
                                                  form +='<a data-toggle="modal" class ="btn btn-info btn-sm" onclick ="ImprimerEtat(\'DemandeHospitalisation\','+result[i].id+')" data-toggle="tooltip" title="Imprimer un Etat de Sortie" data-placement="bottom" '+disabled+'><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>';
