	...
	<div class="col-sm-12">
		<div class="center">
			<h1 class="blue">
				...
				<q> {{ App\modeles\employ::where("id",Auth::user()->employee_id)->get()->first()->nom }}
				{{ App\modeles\employ::where("id",Auth::user()->employee_id)->get()->first()->prenom}} </q>
			</h1>
		</div>
	</div>		
</div>	{{-- row --}}
...
<div class="col-sm-12">
	...
	<div class="space-12"></div>
		<div class="row">
			<div class="panel panel-default"><div class="panel-heading"><h3>Rechercher un  Patient</h3></div>
...
<div class="col-sm-6 offset-sm-1"> 
	...
	<div class="infobox infobox-red">
		<div class="infobox-icon">	<i class="ace-icon fa fa-hospital-o"></i></div>
		<div class="infobox-data">
