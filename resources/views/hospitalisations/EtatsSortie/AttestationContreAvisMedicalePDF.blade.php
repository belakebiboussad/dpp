      ...
      <main> 
        ...
        <section class="borderv">
          <div class="marge">
            ...
            Certifie avoir été informé que {{ $obj->patient->getCivilite()}} {{ $obj->patient->Nom }}&nbsp;
            {{ $obj->patient->Prenom }} actuellement hospitalisé(e) à l'Hôpital refuse les soins proposés et 
        ...
        <div class="marge">
          Je soussigné(e), <br>
          {{ $obj->patient->getCivilite() }} {{ $obj->patient->getCivilite()}} {{ $obj->patient->Nom }}&nbsp;
          {{ $obj->patient->Prenom }} actuellement hospitalisé(e) à l'Hôpital refuse les soins proposés et déclare vouloir 
