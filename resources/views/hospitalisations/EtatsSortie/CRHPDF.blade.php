  ...
  <body>
    <div>
      ...
      <main><br><br><br>
        ...
        <div><b>Né le :</b><span>{{ $obj->patient->dob->format('Y-m-d') }}</span></div>
        <div><b>Motif d’hospitalisation :</b>
          <span>
          @if(isset($obj->admission->id_rdvHosp)) {{-- $obj->admission->demandeHospitalisation->DemeandeColloque->observation --}}
