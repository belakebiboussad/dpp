 ...
 <div class="row">
	<div class="col-sm-6">
		<div class="form-group {{ $errors->has('nomf') ? 'has-error' : '' }}">
			<label class="col-sm-3 control-label" for="nomf">Nom :<span style="color: red">*</span></label>
			<div class="col-sm-9">
...
<div class="row">
	...
	<div class="col-sm-6">
		<div class="form-group">
			<label class="col-sm-3 control-label text-nowrap" for="gsf">Groupe sanguin :<span style="color: red">*</span></label>
			<div class="col-sm-3">
			...
			<label class="col-sm-3 control-label no-padding-right" for="rh">Rhésus :<span style="color: red">*</span></label>
			<div class="col-sm-3">
...
<div class="row">
	...
	<div class="col-sm-4">
		<div class="form-group">
			<label class="control-label col-xs-12 col-sm-3" for="nss2">NSS :<span style="color: red">*</span></label>		
			<div class="col-sm-9">
			<div class="clearfix">
