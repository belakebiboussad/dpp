...
<div class="page-header"><h1><strong>Détails du Consultation Pour :</strong> {{ $patient->Nom }} {{ $patient->Prenom }}</h1></div>
<div class="row">
	<div class="col-sm-6">
			...
			<div class="widget-body">
				<div class="widget-main">
					<div class="row">
						<div class="col-xs-12">
							<div  class="col-xs-9">
								<label for="form-field-8"><strong>Médicament</strong></label>
							  <input id="nommedic" class="form-control" type="text"  placeholder="Médicament"/>
							</div>
							<div  class="col-xs-3">
								<label for="form-field-8"><strong>Présentation</strong></label><input id="forme" class="form-control" type="text"  placeholder="Forme"/>	
							</div><br/><br/><br/><br/>
							<div  class="col-xs-3">
								<label for="form-field-8"><strong>Qte</strong></label><input id="qte" class="form-control" type="number"/>
							</div>
							<div class="col-xs-9">
								<label><strong>Nombre de Prise</strong></label><br>
								<div class="col-xs-2"><input id="nbprise" class="form-control" type="number"/></div>
								<div class="col-xs-4"><input class="form-control"  type="text" value="Fois Par" /></div>
								<div class="col-xs-4">
							...
							<div class="col-xs-7">
								<label><strong>Pendant</strong></label><br/>
								<div class="col-xs-3"><input id="duree" class="form-control" type="number"/></div>
								<div class="col-xs-4">
							...
							<div>
							<div class="col-xs-3">
								<label for="form-field-8">	<strong>à prendre</strong></label>
							...
							<div class="col-xs-12">
								<label for="form-field-8"><strong>Posologie</strong></label>
								<button class="label label-success label-white middle" onclick="posologiefun()">
									<i class="fa fa-check-square-o" aria-hidden="true"></i>Générer automatiquement
								</button>
		...
		<div class="widget-box widget-color-blue" id="widget-box-2">
			<div class="widget-header">
				...
				<div class="widget-toolbar widget-toolbar-light no-border">
					...
					<button type="button" class="btn btn-white btn-purple btn-sm"><i class="ace-icon fa fa-pencil bigger-120 green"></i></button>
				</div>
			</div>
			<div class="widget-body">
				<div class="widget-main">
					<div class="row">
						<div class="col-xs-12">
									...
									<div class="widget-main">
										<div class="row">
											<div class="col-xs-12">
												...
												<div class="col-xs-9">
													<label for="form-field-8"><strong>Pendant</strong></label><br/>
													<div class="col-xs-2">
							...
							<div class="pull-right">
								<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ord" onclick="createord('{{ $patient->Nom }} {{ $patient->Prenom }}','{{ Auth::User()->employ->nom }} {{ Auth::User()->employ->prenom }}')">
									Terminer
								</button>
							</div>
						</div>
