      ...
      <div class="widget-box" id="infopatient">
        ...
        <div class="widget-body">
          <div class="widget-main">
            <div class="row">
              <div class="col-xs-12 col-sm-5"> <label><b>Date Demande:</b></label>&nbsp;&nbsp;&nbsp;&nbsp;<span>{{ $demande->Date }}</span></div>
            </div>
            <div class="row">
              <div class="col-xs-12 col-sm-5"><label><b>Informations cliniques pertinentes :</b></label>&nbsp;&nbsp;<span>{{ $demande->InfosCliniques }}.</span></div>
            </div>
            <div class="row">
              <div class="col-xs-12 col-sm-5"><label><b>Explication de la demande de diagnostic :</b></label>&nbsp;&nbsp;<span>{{ $demande->Explecations }}.</span></div>
            </div>
            <div class="row">
            ...
            <div class="row">
              <div class="col-xs-12 col-sm-5">
               ...
               <div class="col-sm-7 container" id="dicom"  hidden="true"><!-- dicom -->
                  ...
                  <div class="row">
                    ...
                    <input type="checkbox" id="toggleVOILUT">Apply VOI LUT</input><br>
                    <div class="row">
                      <div class="col-md-6">
                        <div style="width:450px;height:512px;position:relative;color: white;display:inline-block;border-style:solid;border-color:black;" oncontextmenu="return false" class='disable-selection noIbar' unselectable='on' onselectstart='return false;' onmousedown='return false;'>
                          <div id="dicomImage" style="width:450px;height:512px;top:0px;left:0px; position:absolute"></div>
                        </div>
                      </div>
                      <div class="col-md-4">
