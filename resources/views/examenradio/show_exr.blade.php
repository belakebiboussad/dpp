...
<script type="text/javascript">
    ...
    try {
            ...
            document.getElementById('transferSyntax').textContent = getTransferSyntax(image);
            document.getElementById('sopClass').textContent = getSopClass(image);
            ...
            document.getElementById('planarConfiguration').textContent = getPlanarConfiguration(image);
            ...
            document.getElementById('pixelRepresentation').textContent = getPixelRepresentation(image);
