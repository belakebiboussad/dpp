				...
				<div class="col-sm-12">		
             	...
             	<strong> Heure entrée Prévue :</strong>
					...
					<div id = "numberofDays" class="col-sm-4 col-xs-4">
						 <label class="col-sm-6 control-label no-padding-right" for="numberDays">
				              	<strong> Durée Prévue :</strong>
				           	</label>
					 	<div class="col-sm-6 col-xs-6">
							<input class="col-xs-8 col-sm-8" id="numberDays" name="" type="number" placeholder="nombre de nuit(s)"
