...
<body>	
	...
	<div class="tab-space"><strong>Nom & Prenom :&nbsp;</strong><span>{{ $rdv->demandeHospitalisation->consultation->patient->Nom }} &nbsp;{{ $rdv->demandeHospitalisation->consultation->patient->Prenom  }}</span></div>
		<div  class="tab-space">
		...
		<div class="tab-space"><strong>Date RDV :&nbsp;</strong><span>{{ $rdv->date_RDVh}} </span></div>
		<div class="tab-space"><strong>Heure RDV :&nbsp;</strong><span>{{ $rdv->heure_RDVh}} </span></div>
		...
		<div>
			<p  class="espace">
				Nous vous informons que votre rendez-vous d'hospitalisation dans notre service <strong>&quot;{{ $rdv->demandeHospitalisation->Service->nom }}&quot;</strong>est pour le: <strong>&quot;{{ $rdv->date_RDVh }}&quot;</strong>.
			</p>
