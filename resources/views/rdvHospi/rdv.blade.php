...
<body>
  ...
  <div class="row">
    <div class="col-xs-6 col-sm-4"></div>
	  <div class="col-xs-6 col-sm-8" style="line-height:10px"><!-- <h5 style="text-align:center;">HOPITAL CENTRAL DE LA SURETE NATIONAL "LES GLYCINES"</h5> -->
  		<h5 style="text-align:center;">{{ $etablissement->nom }}</h5>
  		<h5 style="text-align:center;">Tél : {{ $etablissement->tel }}</h5><!-- <h5 style="text-align:center;">Tél : 023-93-34</h5> -->
	  </div>
  </div>
  <div class="row">
