							...
							<form class="form-horizontal" role="form" method="POST" action="{{ route('salle.update', $salle->id) }}">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<div class="radio">
											<label>
												<input name="etat" value="bloquée" type="radio" class="ace" {{ $salle->etat == "bloquée" ? "checked" : "" }}/>
												<span class="lbl"> bloquée</span>
											</label>
										</div>
										<div class="radio">
											<label>
												<input name="etat" value="Non bloquée" type="radio" class="ace" {{ $salle->etat == "Non bloquée" ? "checked" : "" }}/>
