...
@section('main-content')
	<div class="row"><h4><strong>Modifier les données de la chambre "{{ $salle->nom }}" :</strong></h4>
	</div>
	<div class="row">
		<div class="col-xs-12">
			<div class="widget-box" id="widget-box-1">
			<div class="widget-header">
				<h5 class="widget-title"><strong>Modifier les données d'une chambre :</strong></h5>
			</div>
