...
<div class="row">
	...
	<div class="widget-header">
		 <h5 class="widget-title bigger lighter"><font color="black"><i class="ace-icon fa fa-table"></i>&nbsp;<b>Antécédants  Pathologiques</b></font></h5>
		...
		<div class="widget-main no-padding">
			<table class="table nowrap dataTable table-bordered no-footer table-condensed table-scrollable" id="antsTab">
				<thead class="thin-border-bottom">
				  <tr>
					<th class ="hidden"></th>
					<th class="center"><strong>Nature</strong></th>
				...
				<tbody>
				 @foreach($patient->antecedants as $antcd)
					...
					<tr id="{{ 'atcd'.$antcd->id }}">
						...
						<td class="center"> 
							<button type="button" class="btn btn-xs btn-info open-modal" data-atcd ="c"  value="{{$antcd->id}}"><i class="fa fa-edit fa-lg" aria-hidden="true"></i></button>
