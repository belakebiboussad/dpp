		...
		<div class="widget-body">
		    ...
		    <tr>
			      ...
			      <td>
							...
							<label for="{{$i}}p2">
							<input type="radio"  class="radioM" name="prop{{$demande->id}}" id="{{$i}}p2" value="2" checked/>2</label>&nbsp;&nbsp;
                   						 <label for="{{$i}}p3">
                   						 <input type="radio"  class="radioM" name="prop{{$demande->id}}" id="{{$i}}3" value="3" />3</label>
				         			</div>
				        		</td>
				        		<td>
