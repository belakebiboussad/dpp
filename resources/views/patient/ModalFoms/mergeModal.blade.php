<div  id="mergeModal" class="modal fade" role="dialog" aria-hidden="true"> 
  <div class="modal-dialog modal-lg">
      ...
      <h1 class="center">êtes-vous sûr de vouloir merger les deux patients ?</h1>
				<p><span  class="red">mergé les patient est permanent et ne  peut pas  étre refait !!</span></p>
   		<form id="form-merge" role="form" method="POST" action="{{ route('patients.merge') }}">
      	  {{ csrf_field() }}
	      	<div id="tablePatientToMerge"></div>
	        <div class="modal-footer">
            <button  type="submit" class="btn btn-xs btn-primary"><i class="ace-icon fa fa-save"></i>Enregistrer</button>
