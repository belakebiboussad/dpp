		...
		<div class="modal-content">
          ...
          <label>
            ...
            <select name="input-stream_constraints" class="tt-input input-sx">
              <option value="320x240">320px</option><option value="640x480">640px</option> <option value="800x600">800px</option>
              <option selected="selected" value="1280x720">1280px</option>
              <option value="1600x960">1600px</option><option value="1920x1080">1920px</option>
            </select>
          </label>
            ...
            <select name="input-stream_constraints" id="deviceSelection" class="tt-input input-sx">
         	...
         	<label style="display: none">
          	<span>Zoom</span><select name="settings_zoom" class="tt-input input-sx"></select>	
			    </label>
			    <label style="display: none">
			      <span>Torch</span>
