  ...
  <div class="row tabs">
	    ...
	    <div class="row">
		  ...
		  <div class="tab-content">
				...
				<div id ="homme_cPart">
					<div class="row"><div class="col-sm-12"><h4 class="header smaller lighter blue"><b><strong>Information Homme de confiance</strong></b></h4></div></div>
					<div class="row">
					<div class="col-sm-6">
				...
				<div class="row"><div class="col-sm-12"><h4 class="header smaller lighter blue"><b><strong>Contact</strong></b></h4></div></div>{{-- row --}}
				<div class="space-12"></div>
				<div class="row">
					<div class="col-sm-5">
						<div class="form-group">
