...
<div class="row demograph">
	...
	<div class="col-sm-6">
		<div class="form-group {{ $errors->has('prenom') ? 'has-error' : '' }}">
			...
			<div class="col-sm-9">
				<input type="text" id="prenom" name="prenom" placeholder="Prénom..." class="col-xs-12 col-sm-12" value="{{ old('prenom') }}" autocomplete="off"/>
...
<div class="row demograph">
	<div class="col-sm-6">
		<div class="form-group {{ $errors->has('sexe') ? 'has-error' : '' }}">
			<label class="col-sm-3 control-label" for="sexe">Genre :<span style="color: red">*</span></label>
			<div class="col-sm-9">
				<div class="radio">
