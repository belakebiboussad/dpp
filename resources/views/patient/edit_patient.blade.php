			...
			<div class="col-sm-6">
      		...
      		<div class="row">
				...
				<div class="form-group {{ $errors->has('datenaissance') ? "has-error" : "" }}">
					...
					<div class="col-sm-9">
						<input class="col-xs-12 col-sm-12 date-picker" id="datenaissance" name="datenaissance" type="text" placeholder="Date de naissance..." data-date-format="yyyy-mm-dd" value="{{ $patient->Dat_Naissance }}" required/>
