...
<div class="row">
    ...
    <div class="col-lg-6">
      <div class="widget">
        ...
        <div class="widget-body medium no-padding">
          ...
          <canvas id = "canvaslit" style="width:300px !important;height:300px !important;"></canvas>
  ...
  <div class="row">
    <div class="col-lg-6">
      <div class="widget">
        <div class="widget-title">
          <i class="fa fa-cloud-download"></i>Nombre de Consultaions 
          <a class="pull-right" href="/stats/view">Plus de statistiques</a>
          <div class="clearfix"></div>
        </div>
        <div class="widget-body medium no-padding">
      ...
      success:function(data,status, xhr){
        for (key in data) {
          ...
          //$(".nbrconsult").html(xhr.getResponseHeader("nbcons"));
           // $(".numberhosp").html(xhr.getResponseHeader("nbhosp"));
           // $(".nouvhosp").html(xhr.getResponseHeader("nvhosp"));      
        }
