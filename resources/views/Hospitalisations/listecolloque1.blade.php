...
<div class="col-xs-12">
	...
	<select id="demh" multiple="multiple" name="demh[]" hidden="">
		...
		<div class="col-xs-6">
			<select id="liste_membre" data-placeholder="sélectionner les membres..."  style="width: 400px ">
				
			</select>	
		</div>
		<div class="col-xs-6">
			<textarea id="choix_membre" style="width: 500px" resize="none" readonly ></textarea>
		</div>
		...
		<div class="widget-box widget-color-blue" id="widget-box-2">
			<div class="widget-header">
				<h5 class="widget-title bigger lighter">
					...
					Liste Des demandes d'hoqpitalisation :
				</h5>
			</div>
	...
	<div class="col-xs-5 widget-container-col" id="widget-container-col-4">
		<div class="widget-box widget-color-blue" id="widget-box-4">
			<div class="widget-header">
				<h5 class="widget-title bigger lighter">
					<i class="ace-icon fa fa-table"></i>
					Liste des hoqpitalisations à programmer cette semaine
				</h5>
			</div>
			<div class="widget-body">
				<div class="widget-main no-padding">
