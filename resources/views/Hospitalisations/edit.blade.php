...
<div class="row">
  <div class="col-xs-12">
      ...
      <div class="row form-group ">
        <div class="col-xs-4">
          <label class="col-sm-4 control-label no-padding-right" for="service">
        ...
        <div class="col-xs-4">
          <label class="col-sm-4 control-label no-padding-right" for="modeAdm">
      ...
      <div class="row form-group">
      	<div class="col-xs-4">
          <label class="col-sm-4 control-label no-padding-right" for="medecin">
            <strong>Medecin Traitant:</strong>
          </label>
          <div class="col-sm-8">
            <input type="text" id="medecin" name="medecin" value="{{ $hosp->admission->rdvHosp->demandeHospitalisation->DemeandeColloque->medecin->Nom_Employe }} {{$hosp->admission->rdvHosp->demandeHospitalisation->DemeandeColloque->medecin->Prenom_Employe}}" class="col-xs-12 col-sm-12" readonly/>
          </div>  
        </div>
        <div class="col-xs-4">
          <div class="form-group">
            <label class="col-sm-4 control-label no-padding-right" for="priorite">
        ...
        <div class="col-xs-4">
          <label class="col-sm-4 control-label no-padding-right" for="observ">
      ...
      <div class="space-12"></div>
			  <div class="row form-group">
      		<div class="col-xs-4">
          	<label class="col-sm-4 control-label no-padding-right" for="Date_entree">
           		<strong> Date: </strong>
            </label>
            <div class="col-sm-8">
              ...
              <button class="btn btn-md filelink" onclick="$('#dateEntree').focus()">
        ...
        <div class="page-header"><h1>Sortie Prévue</h1></div>
     	  <div class="row form-group">
	        <div class="col-xs-4">
	          <label class="col-sm-4 control-label no-padding-right" for="Date_Prevu_Sortie">
	            <strong> Date:</strong>
	          </label>
	          <div class="col-sm-8">
	              ...
	              <button class="btn btn-md filelink"  onclick="$('#dateSortiePre').focus();" >
	                <i class="fa fa-calendar"></i>
	               </button>
	           </div>
	        </div>
		      <div class="col-xs-4">
		        <label class="col-sm-4 control-label no-padding-right" for="Heure_Prevu_Sortie">
		              <strong> Heure:</strong>
		          </label>
		          <div class="col-sm-8">   
		              <input id="heureSortiePrevue" name="Heure_Prevu_Sortie" class="col-xs-9 col-sm-9 timepicker" type="text" value = "{{ $hosp->Heure_Prevu_Sortie }}" @if(in_array(Auth::user()->role->id,[5])) disabled @endif/>
			      			<button class="btn btn-md filelink" onclick="$('#heureSortiePrevue').focus()">	
			                <i class="fa fa-clock-o bigger-110"></i>
			            </button>
		          </div>
        	</div>
      ...
      <div class="row form group">
        ...
        <div class="col-xs-4">
          <label class="col-sm-4 control-label" for="heure_rdvh">
            <strong>Lit : 
              </strong>
            </label>
            <div class="col-sm-8">
