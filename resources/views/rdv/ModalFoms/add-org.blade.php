	          ...
	          <div class="row">
			      ...
			      <div class="panel panel-default">
             		...
             		<div class="panel-body">
		           	...
		           	</div>{{--<div class="col-sm-6"><div class="form-group"><label class="col-form-label" for=""><strong>Médecin: </strong></label><select class="form-control" id="medecin" name ="medecin" disabled ></select></div></div> --}}
			          </div>
			          </div>
	          </div>
	          @endif
