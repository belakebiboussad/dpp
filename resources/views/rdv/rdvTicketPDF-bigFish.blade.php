...
{{-- <h5><strong>{{ $etablissement->tutelle }}</strong></h5><h6 class="mt-5" style =" margin-left: -7px;margin-right:-7px;"><strong>{{ $etablissement->nom }}</strong></h6><h6 class="mt-10"><strong>{{ $etablissement->adresse }}</strong><span> - Tél : {{ $etablissement->tel }}</span></h6> --}}
