...
<div class="row">
	...
	<div class="col-sm-2"><strong>Nom :&nbsp;</strong><span>{{ $patient->Nom }}</span></div>
...
<div class="row"><div class="col-sm-2 center"></div>
	<div class="col-sm-8 center"><h3>Compte rendu d'analyses médicales</h3></div>
