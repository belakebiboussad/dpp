										...
										<tbody>
											@foreach($demande->dispositifs as $dispositif)
												<tr>
													...
													<td><input type="number" name="quantite" value="{{ $dispositif->pivot->qte }}"></td>
											...
											@foreach($demande->medicaments as $medicament)
												<tr>
													...
													<td> Médicament</td>
													<td><input type="number" name="quantite" value="{{ $medicament->pivot->qte }}"></td>
												</tr>
											@endforeach
											@foreach($demande->reactifs as $reactif)
												<tr>
													...
													<td><input type="number" name="quantite" value="{{ $reactif->pivot->qte }}"></td>
												</tr>
											@endforeach
										</tbody>
									</table>
