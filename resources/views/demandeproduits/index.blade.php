                    ...
                    <th class="center">Chef de service</th><th class="center"><em class="fa fa-cog"></em></th>
                      ...
                      <td>{{ $demande->demandeur->full_name }}</td>
											<td class="center">
												...
												@if((Auth::user()->is(14)) && (is_null($demande->etat)))
												<a href="{{ route('demandeproduit.edit',$demande->id) }}" class="btn btn-primary btn-xs" title="Modifier Demande"><i class="fa fa-edit fa-xs"></i></a>
