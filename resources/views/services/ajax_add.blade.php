      ...
      <div class="widget-body">
        <div class="widget-main">
          <form role="form" id="serviceFrm" method="POST" action="{{ route('service.store') }}">
            <div class="form-group row"><label class="col-sm-3 col-control-label text-right">Nom :</label>
              <div class="col-sm-9">
                <input type="text" name="nom" placeholder="Nom du dervice" class="form-control"/>
              </div>
            </div>
            <div class="form-group row"><label class="col-sm-3 control-label text-right">Type :</label>
              <div class="col-sm-9">
          ...
          <div class="form-group healthServ row"><label class="col-sm-3 control-label text-right">Spécialite :</label>
              <div class="col-sm-9">
              <select name="specialite_id" id="specialite_id" class="form-control selectpicker" required>
                <option value="" disabled selected>---Séléctionner---</option>
              </select> 
              </div>
            </div>
            <div class="form-group row">
              <label class="col-sm-3 col-control-label text-right">Chef :</label>
              <div class="col-sm-9">
                <select name="responsable_id"  class="form-control selectpicker">
            ...
            <div class="row center">
              ...
              <button class="btn btn-xs btn-warning" type="reset"><i class="ace-icon fa fa-undo bigger-110"></i>Annuler</button>
            </div>
          </form>
        </div>
      </div>
