...
<div class="row">
	<div class="col-xs-12">
        ...
        <div class="form-group">
          <label for="nom" class="col-sm-3 control-label text-right">Nom</label>
          <div class="col-sm-9"><p class = "form-control-static">{{ $service->nom }}</p></div>
        </div>
 				<div class="form-group row">
					<label class="col-sm-3 control-label text-right">Type</label>
					<div class="col-sm-9"><p class = "form-control-static">{{ $service->TypeS }}</p></div>
        </div>
				<div class="form-group row">
