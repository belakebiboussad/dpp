<div class="page-header"><h4><strong>Modifier le  service "{{ $service->nom }}"</strong></h4></div>
<div class="row">
  <div class="col-xs-12">
    <div class="widget-box">
      <div class="widget-header"><h5 class="widget-title"><strong>Service &nbsp; &quot;{{ $service->nom}} &quot;</strong></h5></div>
