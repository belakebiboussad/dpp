<div class="row"><h4><strong>Modifier le  service"{{ $service->nom }}"</strong></h4></div>
<div class="row">
  <div class="col-xs-12">
    <div class="widget-box">
      <div class="widget-header"><h5 class="widget-title"><strong>Modifier le  service &nbsp; &quot;{{ $service->nom}} &quot;</strong></h5></div>
        ...
        <div class="widget-main">
          <form class="form-horizontal" role="form" method="POST" action="{{ route('service.update', $service->id) }}">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <select id="type" name="type"  class="selectpicker show-menu-arrow col-xs-12 col-sm-12" required >
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <select id="responsable_id" name="responsable_id"  class="selectpicker show-menu-arrow col-xs-12 col-sm-12">
