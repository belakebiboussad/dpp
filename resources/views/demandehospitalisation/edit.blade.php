										...
										<div class="row">
											<div class="col-sm-6 col-xs-6">
										            ...
										            <div class="col-sm-8 col-xs-8">
														   	...
														   	<option value="{{ $mode}}" @if($demande->modeAdmission == $mode ) selected @endif>{{ $mode }}
														   	</option>
														   	 @endforeach    
						              					</select> 
						            					</div>
							         			...
							         			<div class="col-sm-6 col-xs-6">
											       <label class="col-sm-4 col-xs-4 control-label no-padding-right text-right" for="specialiteDemande"><strong>Specialite :</strong>
											       </label>
											       <div class="col-sm-8 col-xs-8"> 	 
