						...
						<div class="widget-body">
							<div class="widget-main padding-24">
								<div class="row">
									<div class="col-sm-6">
										<div class="row">
											<div class="col-xs-11 label label-lg label-info arrowed-in arrowed-right"><b>Les Informations Du Patient :</b></div>
										</div>
										<div>
											<ul class="list-unstyled spaced">
												...
												<li>
													<i class="ace-icon fa fa-caret-right blue"></i>
													<strong>Age :</strong><b class="green">{{ Jenssegers\Date\Date::parse($demande->consultation->patient->Dat_Naissance)->age }} ans</b>
												</li>
											</ul>
										</div>
									</div><!-- /.col -->
