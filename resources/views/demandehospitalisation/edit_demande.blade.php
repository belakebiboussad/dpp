								...
								<div class="widget-body">
									<div class="widget-main">
						         	...
						         	<div class="col-sm-6 col-xs-6">
										...
										<div class="row">
											<div class="col-sm-6 col-xs-6">
										    <label class="col-sm-4 col-xs-4 control-label no-padding-right text-right" for="service"><strong>Service :</strong></label>
										    <div class="col-sm-8 col-xs-8">
			...
			<div class="widget-body">
				<div class="widget-main">
					<form method="POST" action="{{ route('demandehosp.update',$demande->id) }}">
						...
						<div>
							<label for="form-field-select-3">	<strong>Service :</strong></label><br />
