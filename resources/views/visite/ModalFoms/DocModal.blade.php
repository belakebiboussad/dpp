    <div id="DocModal" class="modal fade" role="dialog">
      <div class="modal-dialog modal-lg">
        <div  id="" class="modal-content custom-height-modal">
          <div class="modal-header">
            ...
            <h4 class="modal-title">Attacher un document médical</h4>
      ...
      <div class="space-12"></div>
            ...
            <div class="space-12"></div>
              <div class="row">
                ...
                <div class="col-sm-7">
                  <input  id="nomDoc" name="nomDoc" class="form-control" required/>             </div>  
              </div>
      <div class="space-12"></div>
      ...
      <div class="space-12"></div>
          ...
          <div class="clearfix form-actions">
           ...
           <button class="btn btn-info" type="submit" id="EnregistrerDoc" value ="add"> <!--  <i class="ace-icon fa fa-upload bigger-110"></i> -->
         ...
         <
               ...
               <button type="button" id="fermer"class="btn btn-default btn-sm" data-dismiss="modal">
