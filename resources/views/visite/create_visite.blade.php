			...
			<div class="widget-box">
				<div class="widget-body">
					...
					<input id="timepicker1" name="heurevisite" hidden="true" type="text"/>
										...
										<div class="col-sm-9">
											<input name="cons" id="cons" class="form-control">
											</div>
											</div>
											<div class="form-group">
											<label for="" class="col-sm-3 control-label no-padding-right"><b>Nombre de jours:</b></label>
										<div class="col-sm-9">
											<input type="number" id="nbr_j" class="form-control" />
											</div>
											</div>
												<div align="center">
<label class="checkbox-inline"><input type="checkbox" name="p[]" id="Matin" value="Matin"><b>Matin</b></label>
						      ...
						      <thead>
						     	<tr>
						        	...
						        	<th scope="col">Soir</th>
						      		<th scope="col"> <i id='Sup' type='button' class="glyphicon glyphicon-trash red"></i></th>
						      	</tr>
						      </thead>				    
						      <tbody>						      	
						      </tbody>
										...
										<hr>	
						       <div align="center">
						 <button type="submit" id="convert" class="btn btn-info"> Enregistrer </button>
									 </div>		
	</form>
...
$("#addtolist").click(function(){
  $( "#tabconsigne" ).append( "<tr><td>"+i+"</td><td>"+$("#cons").val()+"</td><td>"+$("#nbr_j").val()+"</td><td><input type='checkbox' value='"+$("#Matin").val()+"' checked='"+$("#Matin").prop('checked')+"'></td><td><input type='checkbox' value='"+$("#Midi").val()+"' checked='"+$("#Midi").prop('checked')+"'></td><td><input type='checkbox' value='"+$("#Soir").val()+"' checked='"+$("#Soir").prop('checked')+"'></td><td>"+"</td></tr>" );
  i = i + 1;
}); 
