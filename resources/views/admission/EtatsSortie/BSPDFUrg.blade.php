    ...
    <section class="table solid" style="width:100%;">
     <table>
        ...
        <tr>
            ...
            <td class="plh"><b>Date d'admission :</b><span> {{ $date }}</span></td>
        </tr>
        <tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr> 
        <tr>
          <td class="plh"><b>Service :</b><span> {{ $obj->bedAffectation->lit->salle->service->nom}}</span></td>
          <td class="plh"><b>Salle :</b><span> {{ $obj->bedAffectation->lit->salle->num }}</span></td>
          <td class="plh"><b>Lit :</b><span> {{ $obj->bedAffectation->lit->num }}</span></td>
        </tr>
        <tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr> 
        <tr>
