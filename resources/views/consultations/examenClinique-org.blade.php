<div id="ExamGeneral" class="tabpanel">
	...
	<div class="row">
		<div  class="tab-content" style ="border-style: none;">
       			...
       			<div class= "col-md-8 col-xs-8"> 
        				<div class="row">
        					<div class="form-group">
	        					<div class="col-xs-2">
								<label class="col-xs-12 control-label no-padding-right right" for="taille"><strong>Taille :</strong></label>
							</div>
							<div class="col-xs-2">
			...
			<div class= "col-md-4 col-xs-4 col-offset-md-1"><br/><br/><br/>
	 			<div class="right">
     				    	  <div class="profile-contact-links align-right">
         	 				<a  href="#" data-target="#Ordonnance" class="btn btn-primary btn-lg" style="width:100%;" data-toggle="modal">
			...
			<div role="tabpanel" class = "tab-pane" id="Appareils"><div class="space-12"></div><div class="space-12"></div><div class="space-12"></div>
				<div class= "col-md-8 col-xs-8">@include("consultations.ExamenAppareils")</div>	{{-- col-md-8 col-xs-9 --}} 
			 	<div class= "col-md-4 col-xs-4"><br/><br/><br/>
					<div class="right">
           			 <div class="profile-contact-links align-right">
