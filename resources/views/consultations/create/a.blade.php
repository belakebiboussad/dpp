...
/* $('#modal-wizard-container').ace_wizard();$('#modal-wizard .wizard-actions .btn[data-dismiss=modal]').removeAttr('disabled');*/
        /**
...
<div class="main-content">
  <div class="main-content-inner">
    <div class="page-content">
      <div class="page-header"> <h1>Nouvelle Consultation</h1></div><!-- /.page-header -->
        <div class="row">
          <div class="col-xs-12">
              ...
              <div class="col-xs-12">    
                <div class="widget-box">
                  <div class="widget-header widget-header-blue widget-header-flat">
                    <h4 class="widget-title lighter">Nouvelle consultation</h4>
                        ...
                        <div>
                          <ul class="steps" style="margin-left: -1px">
                            <li data-step="1" class="complete">
                              ...
                              <span class="title">Intérrogatoire</span>
                            </li>
                            ...
                            <li data-step="3" class="">
                              ...
                              <span class="title">Examen complémentaires</span>
                            </li>
                            <li data-step="4">
