      ...
      <div class="modal-footer" style="width:100%">  
        <div style="bottom:0; padding-right:1.2%">
            <button type="button" class="btn btn-primary btn-xs" data-dismiss="modal" onclick="storeord1()"><i class="ace-icon fa fa-save bigger-110"></i>Enregistrer</button>
              <button type="button" class="btn btn-primary btn-xs"  data-toggle="modal" data-dismiss="modal" onclick="createord('{{ $patient->Nom }} {{ $patient->Prenom }}','{{ Auth::User()->employ->Nom_Employe }} {{ Auth::User()->employ->Prenom_Employe }}')">
