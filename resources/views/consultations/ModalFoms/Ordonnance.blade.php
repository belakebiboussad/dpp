    ...
    <div class="modal-content contmodal">
      ...
      <div class="modal-footer" style="width:100%">  
        <div style="bottom:0; padding-right:1.2%">
            ...
            <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#ord" data-dismiss="modal" onclick="createord('{{ $patient->Nom }} {{ $patient->Prenom }}','{{ $patient->Dat_Naissance }}','{{ $patient->$codebarre }}','{{ Auth::User()->employ->Nom_Employe }} {{ Auth::User()->employ->Prenom_Employe }}')">
