<div class="modal fade" id="Ordonnance" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog  modaldialog" >
    <div class="modal-content contmodal">
      ...
      <div class="modal-footer m-b-0">    <!-- <div style="bottom:0; padding-right:1.2%"> </div> -->
          ...
          <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#ord" data-dismiss="modal" onclick="createord('{{ $patient->Nom }} {{ $patient->Prenom }}','{{ $patient->Dat_Naissance }}','{{ $patient->IPP }}',{{ $patient->getAge()}},'{{ $patient->Sexe }}','{{ Auth::User()->employ->Nom_Employe }} {{ Auth::User()->employ->Prenom_Employe }}')">
