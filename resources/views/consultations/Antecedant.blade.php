<div class="row">
	<div class="col-sm-12">
		<h3 class="header smaller lighter blue">Antecedants Personnels</h3>
	</div>
</div>	{{-- row --}}
  ...
  <div class="widget-header" >
    ...
    <div class="widget-toolbar widget-toolbar-light no-border" width="20%">
			<div class="fa fa-plus-circle"></div>
		 	<a href="#" id="btn-add" name="btn-add" class="btn-xs tooltip-link" data-toggle="modal"  data-toggle="tooltip" data-original-title="Ajouter un Antecedant Personnels">
...
<div class="row">
	<div class="col-sm-12">
		<h3 class="header smaller lighter blue">Antecedants Familliaux</h3>
	</div>
</div>	{{-- row --}}
  <div class="row">
  <div class= "widget-box widget-color-green" id="widget-box-2">
	  <div class="widget-header" >
	    ...
	    <div class="widget-toolbar widget-toolbar-light no-border" width="20%">
				<div class="fa fa-plus-circle"></div>
			 	<a href="#" id="AntFamil-add" name="AntFamil-add" class="btn-xs tooltip-link" data-toggle="modal"  data-toggle="tooltip" data-original-title="Ajouter un Antecedant Familliaux" >
		 			<h4><strong>Antecedant</strong></h4>
		 		</a>
		 	</div>
	  </div>
