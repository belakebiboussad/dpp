 	...
 	<div class="row">
					  ...
					  @if(isset($consultation->demandeExamImagegerie) )	 
						...
						<li class="">
							<a data-toggle="tab" href="#ordonnance" aria-expanded="false">	
								<i class="orange ace-icon fa fa-medkit bigger-120"></i>	Ordonnance
							</a>
						</li>
						@endif
				</ul>
		...
		<div class="widget-main padding-6">
			...
			<div id="Intero" class="tab-pane in active">
				...
				<input type="text" id="taille" class =""  style="width:30%;height:10%;border: 0;" readonly value="{{ $consultation->examensCliniques->taille }}"/>
					<span><small>m</small></span>
				</div>
				<div class="col-md-3">
				<label for="poids"><span class="bigger-100"><strong>Poids:</strong></span></label>
				<input type="text" id="poids"  class ="form-control-plaintext" style="border: 0;background-color:transparent;width: 25%; height: 10%;" readonly value="{{ $consultation->examensCliniques->poids }}"/>
					<span><small>Kg</small></span>
				</div>
				<div class="col-md-3">
				<label for="imc"><span class="bigger-100"><b>IMC:</b></span></label>
				<input type="text" id="imc" style="border: 0;width: 20%; height: 10%;" readonly value="{{ $consultation->examensCliniques->IMC }}"/>
				</div>
				<div class="col-md-3">
				<label for="temp"><span class="bigger-100"><b>Temp:</b></span></label>
				<input type="text" id="temp" style="border: 0;width: 25%; height: 10%;" readonly value="{{ $consultation->examensCliniques->temp }}"/>
					<span><small>°C</small></span>
				</div>
				</div>	 {{-- row --}}
				<div class="space-6"></div>
				@if(isset($consultation->examensCliniques->autre))
				<div class="row">
				<div class="col-md-12">
				<label for="autre"><span class="bigger-120"><b>Autre:</b></span></label>
				<textarea type="text" id="autre" style="width: 100%; height:30px;" readonly>{{$consultation->examensCliniques->autre}}</textarea>
				</div>
				</div> {{-- row --}}
				@endif
				@if(isset($consultation->examensCliniques->peaupha))
				<div class="row">
				<div class="col-md-12">
				<label for="peaupha"><span class="bigger-120"><b>Peau et phanéres:</b></span></label>
				<textarea type="text" id="peaupha" style="width: 100%; height:50px;" readonly > {{ $consultation->examensCliniques->peaupha }}</textarea>
				</div>
				</div>
				@endif
				@if(isset($consultation->examensCliniques->Etat))
				<div class="row">
				<div class="col-md-12">	
				<label for="Etat"><span class="bigger-120"><b>Etat Générale:</b></span></label>
				<textarea type="text" id="Etat" style="width:100%; height:50px;" readonly >{{ $consultation->examensCliniques->Etat }}</textarea>
				</div>
				</div>
				@endif
				</div>{{-- ExamClinique --}}
				...
				<div id="eXamBio" class="tab-pane">
						<div class="row">
					        ...
					        <tbody>
										<tr>
										<td class="center"></td>
										<td>{{ $consultation->Date_Consultatione }}</td>
										<td>
