<div class="tabpanel">
	...
	<div class ="tab-content"  style = "border-style: none;" >
		...
		<div class= "col-md-8 col-xs-8"> 
			...
			<div class="row">	
				<div class="form-group {{ $errors->has('motif') ? 'has-error' : '' }}">
					<label class="col-sm-4 control-label no-padding-right" for="motif"><strong>Motif de Consultation : <span style="color: red">*</span></strong>
					</label> 
					<div class="col-sm-8">
    			...
    			<label class="col-sm-4 control-label no-padding-right" for="codecim"><strong>Code Cim10 :</strong></label>
					<div class="col-sm-8 input-group" style="padding-left:15px;">
					    ...
					    <span class="input-group-addon" style=" padding: 0px 6px;"> 
					      <button class="btn btn-xs CimCode" type="button" value="codesim">
		...
		<div role="tabpanel" class = "tab-pane " id="ATCD"> 
			<div class= "col-md-8 col-xs-8">@include('consultations.Antecedant')</div>
			<div class= "col-md-4 col-xs-4"><br/><br/>
				<div class="right">
		     			 <div class="space-12"></div><div class="space-12"></div><div class="space-12"></div>
		     			 <div class="profile-contact-links align-right">
