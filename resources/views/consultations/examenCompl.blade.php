	...
	<div class= "col-md-9 col-xs-9"> @include('consultations.ExamenCompl.ExamenRadio') </div>
        <div class= "col-md-3 col-xs-3">	<br/><br/><br/><br/><br/><br/>
	     <div class="right">
				...
				<div class="space-12"></div>
				<button type="button" class="btn btn-primary btn-lg"  style="width:100%;"  data-toggle="modal" data-target="#dexRadio" onclick="createeximg('{{$patient->Nom}}','{{$patient->Prenom}}','{{ $patient->getAge() }}')">
					<div class="fa fa-print bigger-120"></div><span class="bigger-110"> &nbsp;&nbsp;&nbsp;Imprimer</span>
				</button>
				<div class="space-12"></div>
...
<div id="dexbio" class="modal modal-wide fade" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <iframe id="exbiopdf" src="" frameborder="0" class="preview-pane" type="application/pdf" width="800" height="465"></iframe>
      </div>
 ...
 {{-- fin --}}
  <div id="dexRadio" class="modal modal-wide fade" role="dialog">
	<div class="modal-dialog"><!-- Modal content-->
		<div class="modal-content">
			...
			<!-- style="position:relative;z-index:999" -->
				<iframe id="exradiopdf" src="" frameborder="0" class="preview-pane" type="application/pdf" width="800" height="465"></iframe>
			</div>
