<div id="ExamCompl" class="tabpanel">
	...
	<div class="tab-content" style = "border-style: none;">
          ...
          <div class="fa fa-plus-circle"></div><span class="bigger-110"> Ordonnance</span>
				...
				<div class="space-12"></div> <!-- data-toggle="modal" data-target="#dexbio"  -->
...
<div class="tab-pane" id="radiologique">
	<div class= "col-md-9 col-xs-9"> @include('consultations.ExamenCompl.ExamenRadio') </div>
        <div class= "col-md-3 col-xs-3">	<br/><br/><br/><br/><br/><br/>
	     <div class="right">
		      	<div class="profile-contact-links center">
			     	<a  href="#" data-target="#Ordonnance" class="btn  btn-primary btn-lg tooltip-link" style="width:100%;" data-toggle="modal"   data-toggle="tooltip" data-original-title="" ><div class="fa fa-plus-circle"></div>    <span class="bigger-110"> Ordonnance</span>
				</a>
				<div class="space-12"></div>{{-- data-toggle="modal" data-target="#dexRadio"  --}}
				<button type="button" class="btn btn-primary btn-lg"  style="width:100%;" onclick="createeximg('{{$patient->Nom}}','{{$patient->Prenom}}','{{ $patient->getAge() }}','{{ $patient->IPP }}')">
					<div class="fa fa-print bigger-120"></div><span class="bigger-110"> &nbsp;&nbsp;Imprimer</span>
				</button>
				<div class="space-12"></div>
	       			<a  href="#" data-target="#RDV" class="btn  btn-primary btn-lg tooltip-link" style="width:100%;" data-toggle="modal"   data-toggle="tooltip" data-original-title="" ><div class="fa fa-plus-circle"></div><span class="bigger-110">&nbsp;Rendez-vous</span>
	         		</a>
			</div>
			<div class="space-12"></div>
			<div class="profile-contact-info">
...
<h4 class="modal-title">Demande Examens Biologique :</h4></div><div class="modal-body"><iframe id="exbiopdf" src="" frameborder="0" class="preview-pane" type="application/pdf" width="850" height="690"></iframe>
</div><div class="modal-footer"></div></div><!-- /.modal-content --></div><!-- /.modal-dialog --></div>
--}}<!-- /.modal --> {{-- fin --}}
...
<h4 class="modal-title">Demande Examens d'Imagerie :</h4> </div>
<div class="modal-body"><!-- style="position:relative;z-index:999" -->
<iframe id="exradiopdf" src="" frameborder="0" class="preview-pane" type="application/pdf" width="850" height="690"></iframe></div>
