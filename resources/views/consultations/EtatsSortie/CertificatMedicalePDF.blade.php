<html>
  ...
  <body>
    ...
    <main><br><br><br>	<!--  <hr class="hr-1"/> -->
  	 	<div class="center"><h3><b>{{ $etat->nom }}</b></h3></div><br>
  		<div><b>Service</b> : {{ $obj->medecin->Service->nom }}</div>
  		<div><b>Chef de Servise</b> : {{ $obj->medecin->Service->responsable->full_name }}</div>
  		<div class="mtP10p">
        <p class="espace">
      ...
      <div class="footer">
        <div class="center">Certificat établit pour servir et valoir ce que de droit sur la demande de l'intéréssé et remise en mains propre
        </div>
      </div>
   	</main>
  </body>
