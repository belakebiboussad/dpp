		          ...
		          @foreach($correspondants as $hom)
		            <tr id="{{ 'garde'.$hom->id }}">
		  			...
		  			<button type="button" class="btn btn-xs btn-success open-modal" value="{{$hom->id}}" data-cmd="show">
                       		  ...
                       		  <button type="button" class="btn btn-xs btn-info open-modal" data-atcd ="c" id ="edit" value="{{$hom->id}}"><i class="fa fa-edit fa-xs" aria-hidden="true" style="font-size:16px;"></i>
                       		  </button>
                       	</td>
		            </tr>
		          @endforeach
